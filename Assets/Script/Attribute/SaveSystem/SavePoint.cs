...
public class SavePoint : MonoBehaviour {
	...
	public static void LoadData()
	{
		...
		for (int i = 0; i < enemies.Length; i++)
		{
			...
			enemies [i].enemyAction.attackTarget = null;
			enemies [i].enemyAction.detectedTarget = null;
		}
	}
	...
	void SaveEnemyInfo (EnemyInfo enemyInfo)
	{
		...
		Saver.SaveInt (enemyInfo.gameObject.name, "ActionType", (int)EnemyActionType.Idle);
